...
router.post('/', (req, res) => {
  ...
  */
  Product.create(req.body)
    .then((product) => {
      // if there's product tags, this creates pairings to create multiples in the ProductTag model
      ...
      // just respond if no product tags
